...
-------------------
    ...
    You can either implement the project in airlines.c or simply purge
    this file and implement your project in any file you would like
    (except main.c and airlines.h).  In the top directory there is
...
-------------------
    ...
    project. i.e. './airlines testfile1'.
